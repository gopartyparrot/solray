...
exports.MintLayout = buffer_layout_1.default.struct([
    ...
    (0, encoding_1.publicKey)('mintAuthority'),
    (0, encoding_1.uint64)('supply'),
    ...
    (0, encoding_1.publicKey)('freezeAuthority'),
]);
exports.AccountLayout = buffer_layout_1.default.struct([
    (0, encoding_1.publicKey)('mint'),
    (0, encoding_1.publicKey)('owner'),
    (0, encoding_1.uint64)('amount'),
    buffer_layout_1.default.u32('delegateOption'),
    (0, encoding_1.publicKey)('delegate'),
    buffer_layout_1.default.u8('state'),
    buffer_layout_1.default.u32('isNativeOption'),
    (0, encoding_1.uint64)('isNative'),
    (0, encoding_1.uint64)('delegatedAmount'),
    buffer_layout_1.default.u32('closeAuthorityOption'),
    (0, encoding_1.publicKey)('closeAuthority'),
]);
...
const MultisigLayout = buffer_layout_1.default.struct([
    ...
    (0, encoding_1.publicKey)('signer1'),
    (0, encoding_1.publicKey)('signer2'),
    (0, encoding_1.publicKey)('signer3'),
    (0, encoding_1.publicKey)('signer4'),
    (0, encoding_1.publicKey)('signer5'),
    (0, encoding_1.publicKey)('signer6'),
    (0, encoding_1.publicKey)('signer7'),
    (0, encoding_1.publicKey)('signer8'),
    (0, encoding_1.publicKey)('signer9'),
    (0, encoding_1.publicKey)('signer10'),
    (0, encoding_1.publicKey)('signer11'),
]);
...
class SPLToken extends BaseProgram_1.BaseProgram {
    ...
    async accountInfo(account) {
        ...
        accountInfo.amount = (0, encoding_1.u64FromBuffer)(accountInfo.amount);
        if (accountInfo.delegateOption === 0) {
            ...
            accountInfo.delegatedAmount = (0, encoding_1.u64FromBuffer)(accountInfo.delegatedAmount);
        }
        accountInfo.isInitialized = accountInfo.state !== 0;
        accountInfo.isFrozen = accountInfo.state === 2;
        if (accountInfo.isNativeOption === 1) {
            accountInfo.rentExemptReserve = (0, encoding_1.u64FromBuffer)(accountInfo.isNative);
    ...
    mintToInstruction(params) {
        ...
        return this.instructionEncode(layout, {
            instruction: 7,
            amount: (0, encoding_1.u64LEBuffer)(amount),
        }, [
            { write: token },
            { write: to },
            authority,
    ...
    setAuthorityInstruction(params) {
        ...
        const layout = buffer_layout_1.default.struct([
            ...
            buffer_layout_1.default.u8('option'),
            (0, encoding_1.publicKey)('newAuthority'),
        ]);
        return this.instructionEncode(layout, {
            instruction: 6,
